...
class labelme2coco(object):
    ...
    def __init__(self, root, save_json_path="./coco.json"):
        """
        :param labelme_json: the list of all labelme json file paths
        :param save_json_path: the path to save new json
        """
        self.root = root
        self.labelme_json = sorted(glob.glob(os.path.join(root, "*.json")))
    ...
    def image(self, data, num):
        ...
        try:
            ...
            im_path = os.path.join(self.root, data["imagePath"])
            img = np.asarray(PIL.Image.open(im_path, mode='r'))
...
if __name__ == "__main__":
    ...
    labelme2coco(args.root, args.output)
